...
//const char* host = "8.134.248.39";//cloud server
...
void loop() {
  ...
  Serial.println(host);
    ...
    // Serial.println(msg);
    // client.println(msg);
 String msg1 = "Sensor_Pressure_1:" + String(analogRead(36));
 String msg2 = "Sensor_Pressure_2:" + String(analogRead(35));
 //Serial.println(WiFi.RSSI());
//  Serial.println(msg1);
//  Serial.println(msg2);
 client.println(msg1 + msg2);
 delay(10);
 //client.println(msg1);
  //delay(1000);
}
